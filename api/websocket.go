...
type Hub struct {
	...
	broadcast  chan []byte
	snapshot   func() []byte // returns current device list JSON
}
...
// devicesMessage wraps device statuses in a WebSocket message envelope.
func DevicesMessage(data interface{}) []byte {
